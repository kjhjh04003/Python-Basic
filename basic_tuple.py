...
def tuple_oper():
    ...
    #인덱스 접근 가능
    print("정인덱싱 : ",tp[0], tp[1], tp[2], tp[3], tp[4]) # 정인덱싱
...
def tuple_methods():
    ...
    print("2st 20 : ", tp.index(20, 1)) # 검색 범위의 제한
...
def packing_unpacking():
    ...
    # 좌변의 변수 갯수와 우변의 값의 갯수가 일치하지 않으면 valuesError
    # a, b, c = tp # 변수의 갯수가 튜플의 갯수보다 적기 때문에 에러 발생
    # a, b, c, d, e = tp # 변수의 갯수가 튜플의 갯수보다 많기 때문에 에러 발생
